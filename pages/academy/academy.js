...
const academies = [
  ...
  {
    id: 'cassandra',
    name: 'Apache Cassandra Learning Hub',
    path: '/pages/cassandra-learning-hub/cassandra-learning-hub.html',
    category: 'Databases',
    icon: 'fa-solid fa-layer-group',
    difficulty: 'Intermediate',
    desc: 'Learn Apache Cassandra for wide-column, highly available distributed databases.',
  },
  {
    id: 'redis',
    ...
    icon: 'fa-solid fa-bolt',
    difficulty: 'Beginner',
    desc: 'Master Redis for in-memory data structures, caching, pub/sub, and key expiry.',
  },
