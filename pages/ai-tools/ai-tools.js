...
const aiTools = [
  ...
  {
    name: 'Resume Roast & ATS Visualizer',
    path: '/pages/resume-roast.html',
    category: 'Creative Tools',
    icon: 'fa-file-circle-exclamation',
    desc: 'Get a brutally honest AI roast of your resume alongside an ATS-compatibility breakdown.',
  },
