...
const practiceTools = [
  ...
  // ── Orphaned pages linked (#2024) ──
  {
    ...
    category: 'Simulators',
    icon: 'fa-dragon',
    desc: 'Fight algorithm bosses by writing correct, efficient code under pressure in a retro RPG battle.',
  },
  {
    ...
    category: 'Simulators',
    icon: 'fa-hat-wizard',
    desc: 'Cast code as spells to defeat bosses — solve DSA challenges in a code editor styled as an RPG battle.',
  },
  {
    name: 'Escape Room',
    ...
    category: 'Simulators',
    icon: 'fa-door-closed',
    desc: 'Solve algorithmic puzzles to escape themed rooms against the clock, solo or with others.',
  },
  {
    ...
    category: 'Simulators',
    icon: 'fa-shuffle',
    desc: "Tweak an algorithm's inputs or constraints and see how its behavior and complexity change.",
  },
  {
    ...
    category: 'Other',
    icon: 'fa-diagram-project',
    desc: 'Turn your code into a flowchart or diagram automatically to visualize control flow and structure.',
  },
  {
    ...
    category: 'Other',
    icon: 'fa-sitemap',
    desc: 'Watch the DOM tree build and update live as HTML is parsed and traversed.',
  },
  {
    ...
    category: 'Dashboards',
    icon: 'fa-timeline',
    desc: 'Review what you accomplished in each learning session, laid out on a timeline.',
  },
  {
    ...
    icon: 'fa-chalkboard',
    desc: 'Sketch out algorithms and data structures together in real time on a shared whiteboard.',
  },
  {
    name: 'Peer Coding Study Rooms',
    path: '/pages/community/peer-coding-rooms/peer-coding-rooms.html',
    category: 'Collaboration',
    icon: 'fa-user-group',
    desc: 'Solve coding problems with friends in real time, check leaderboards, and maintain streaks.',
  },
];
