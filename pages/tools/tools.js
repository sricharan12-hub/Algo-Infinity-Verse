...
const practiceTools = [
  ...
  {
    name: 'DOM Tree Traversal Visualizer',
    path: '/pages/tools/dom-visualizer/index.html',
    category: 'Debugging',
    icon: 'fa-sitemap',
    desc: 'Watch DFS and BFS traverse a live mock webpage DOM tree to build intuition for tree algorithms.',
  },
  {
    ...
    category: 'Other',
    icon: 'fa-diagram-project',
    desc: 'Convert your code into visual flow diagrams instantly to understand its structure and logic.',
  },
  {
    ...
    category: 'Simulators',
    icon: 'fa-sliders',
    desc: 'Tweak algorithm parameters and see real-time changes to behavior, performance, and output.',
  },
  {
    ...
    category: 'Simulators',
    icon: 'fa-dragon',
    desc: 'Defeat RPG-style bosses by writing correct algorithm solutions under pressure.',
  },
  {
    ...
    category: 'Simulators',
    icon: 'fa-database',
    desc: 'Practice SQL queries against a real sample database directly in your browser.',
  },
  {
    ...
    category: 'Learning Tools',
    icon: 'fa-chalkboard',
    desc: 'Sketch and explain algorithms together in real time on a shared collaborative whiteboard.',
  },
  {
    name: 'Smart Revision Calendar',
    path: '/pages/revision/revision.html',
    category: 'Learning Tools',
    icon: 'fa-calendar-days',
    desc: 'Personalized study scheduling and spaced repetition tracking dashboard for mastering DSA concepts.',
  },
  {
  ...
  {
    name: 'Algorithm Escape Room',
    path: '/pages/escape-room/index.html',
    category: 'Simulators',
    icon: 'fa-door-open',
    desc: 'Solve algorithm puzzles under time pressure to escape a series of themed rooms.',
  },
];
